...
public class graph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (position.z > 0.00)
        {
            ...
            position.z = -4.2f + position.z * 20f;
        }
    ...
    void Update()
    {
        ...
        if (flag == false)
        {
            for (int i = 0; position_PE.z > -4.3f; i++)
            {
                ...
                position_PE.x += (float)Math.Log(0.0001f * massBall * i * i * i * gravForce + 1, 1000000);
            ...
            for (int i = 0; position_KE.z <= position.z; i++)
            {
                ...
                position_KE.x += (float)Math.Log(0.0001f * massBall * i * i * i * gravForce + 1, 1000000);
